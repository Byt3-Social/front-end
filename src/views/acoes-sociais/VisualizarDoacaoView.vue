<template>
    ...
    <main id="visualizar-doacao-view">
        ...
        <FloatingPanel>
            <template v-slot:FloatingPanelContent v-if="doacao != null">
                <div class="detalhes-transacao">
                    ...
                    <div class="bloco">
                        ...
                        <p class="bloco__atributo--preenchido">{{ cpfMask(doacao.doador.cpf) }}</p>
                    </div>
                    <div class="bloco">
                    ...
                    <div class="bloco">
                        ...
                        <p class="bloco__atributo--preenchido">{{ telefoneMask(doacao.doador.telefone) }}</p>
                    </div>
                    <div class="bloco">
                    ...
                    <div class="bloco">
                        ...
                        <p class="bloco__atributo--preenchido">{{ doacao.metodo.replace("CARTAO_CREDITO", "CRÉDITO") }}</p>
                    </div>
                    <div class="bloco">
                    ...
                    <div class="bloco">
                        ...
                        <p class="bloco__atributo--preenchido">
                            <a :href="doacao.link" v-if="doacao.metodo == 'BOLETO'" target="_blank">Acesse aqui o boleto de
                                pagamento</a>
                            <a :href="doacao.link" v-else-if="doacao.metodo == 'PIX'" target="_blank">Acesse aqui o QR Code
                                de pagamento</a>
                    ...
                    <div class="bloco">
                        ...
                        <p class="bloco__atributo--preenchido">{{ (new Date(doacao.created_at)).toLocaleDateString('pt-BR',
                            options) }}</p>
                    </div>
                    <div class="bloco">
                        <label class="bloco__atributo">Atualizado em</label>
                        <p class="bloco__atributo--preenchido">{{ (new Date(doacao.updated_at)).toLocaleDateString('pt-BR',
                            options) }}</p>
                    </div>
                </div>


                <button class="danger-button" @click.prevent="atualizarEmpresa()" v-if="doacao.status != 'CANCELED'">
...
export default {
    ...
    methods: {
        ...
        buscarDoacao: function (id) {
            axios.get(process.env.VUE_APP_API_BASE_URL + "/doacoes/" + id)
                .then((response) => {
